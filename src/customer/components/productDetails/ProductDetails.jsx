  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          {/* Image gallery */}
          ...
          <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-4">
            <div className="lg:col-span-2 ">
              ...
              <h1 className="text-lg lg-xl text-gray-900 opacity-60 pt-1">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                <Button
                  ...
                  variant="contained"
                  sx={{ p: "2rem", py: "1rem", backgroundColor: "#9155fd" }}>
                  Add To Cart
                </Button>
              </form>
            </div>
              ...
              <Grid
                ...
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    readOnly
                  />
                  <p className="opacity-60">59568 Ratings</p>
                </div>
